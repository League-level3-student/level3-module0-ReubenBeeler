...
public class Firework {
	...
	public void launch() {
		...
		for (Spark spark : sparks) {spark.x = FireworkDisplay.WIDTH/2; spark.y = FireworkDisplay.HEIGHT;}
	...
	public void drawSparks(Graphics g) {
		for (Spark spark : sparks) {
			...
			g.fillOval(spark.x, spark.y, FireworkDisplay.WIDTH, FireworkDisplay.HEIGHT);
		}
